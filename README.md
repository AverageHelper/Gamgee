...
First, you'll need to set up [Docker](https://docs.docker.com/get-docker/) on your host machine.

Once you have your .env file set up, you can build and run the container with:
