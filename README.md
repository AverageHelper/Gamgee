...
or [NodeJS](https://nodejs.org/) (version 16.10 or later), and [NPM](https://npmjs.org/).
...
If you'd like to run Gamgee as a container, we recommend reading the [sample compose file]() and building on that.
